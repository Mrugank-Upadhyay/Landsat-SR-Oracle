...
export const useGlobalStore =  create<GlobalState>()((set) => ({
    ...
    satelliteResolution: {
        "Landsat-8": [
            { bandNum: 1, bandName: "Visible Coastal Aerosol", bandCategory: "Visible", bandResolution: 30 },
            { bandNum: 2, bandName: "Visible Blue", bandCategory: "Visible", bandResolution: 30 },
            { bandNum: 3, bandName: "Visible Green", bandCategory: "Visible", bandResolution: 30 },
            { bandNum: 4, bandName: "Visible Red", bandCategory: "Visible", bandResolution: 30 },
            { bandNum: 5, bandName: "Near-Infrared", bandCategory: "Near-Infrared", bandResolution: 30 },
            { bandNum: 6, bandName: "Shortwave-Infrared 1", bandCategory: "Infrared", bandResolution: 30 },
            { bandNum: 7, bandName: "Shortwave-Infrared 2", bandCategory: "Infrared", bandResolution: 30 },
            { bandNum: 8, bandName: "Panchromatic (PAN)", bandCategory: "Panchromatic", bandResolution: 15 },
            { bandNum: 9, bandName: "Cirrus", bandCategory: "Cirrus", bandResolution: 30 },
            { bandNum: 10, bandName: "Thermal-Infrared Sensor 1", bandCategory: "Thermal-Infrared", bandResolution: 100 },
            { bandNum: 11, bandName: "Thermal-Infrared Sensor 2", bandCategory: "Thermal-Infrared", bandResolution: 100 },
